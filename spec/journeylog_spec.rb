...
describe Journeylog do
  ...
  describe '#start' do
    ...
    it 'should start a new journey with an entry_station' do
  ...
  describe '#current_journey' do
    ...
    it 'should log the entry and exit station of the current journey when complete' do
      journeylog.entry_station = "Old Street"
      journeylog.exit_station = "Haggerston"
      expect(journeylog.current_journey).to eq journeylog.end_journey
    end
  end
